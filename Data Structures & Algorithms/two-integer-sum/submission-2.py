    ...
    def twoSum(self, nums: List[int], target: int) -> List[int]:
        ...
        for i, num in enumerate(nums):
            ...
            if complement in lookup:
                ...
                #return answer with small index first
                #returning i (location of num bc we found the answer) and j (location, other half of the equation)
            
            lookup[num] = i #otherwise store the num for future checks
